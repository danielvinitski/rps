...
public:
	...
	bool MovePiece(int fromX, int fromY, int toX, int toY, int player);
	bool MovePiece(int fromX, int fromY, int toX, int toY, int player, Piece::PieceType changeJokerType);
	bool initBoard();
